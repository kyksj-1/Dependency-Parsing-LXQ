...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  ...
  \item Two reproducible failure modes documented in detail: post-norm SDPA without warmup collapses to near-random accuracy; Muon at its default learning rate of $0.02$ is roughly four times too large for our 9M-parameter SDPA encoder.
  \item Released artifacts: training scripts, an auto-routing Muon wrapper that sends embeddings and biases to AdamW, the unit tests, and a preflight checklist.
\end{itemize}
